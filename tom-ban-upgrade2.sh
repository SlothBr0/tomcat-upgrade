...
# Check for setenv
if [ ! -e "$APP_DIR/tomcat2/bin/setenv.sh" ]; then
...
WorkingDirectory=/u01/app/tomcat2/bin
ExecStart=/u01/app/tomcat2/bin/catalina.sh run

ExecStopPost=/bin/rm -rf /u01/app/tomcat2/temp/*
